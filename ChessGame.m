...
% hObject    handle to checkstat (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of checkstat as text
%        str2double(get(hObject,'String')) returns contents of checkstat as a double


% --- Executes during object creation, after setting all properties.
function checkstat_CreateFcn(hObject, eventdata, handles)
% hObject    handle to checkstat (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in setHard.
function setHard_Callback(hObject, eventdata, handles)
% hObject    handle to setHard (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of setHard

    set(handles.setEasy,'Value',0);
    set(handles.setRandom,'Value',0);


% --- Executes on button press in setEasy.
function setEasy_Callback(hObject, eventdata, handles)
% hObject    handle to setEasy (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of setEasy
    set(handles.setHard,'Value',0);
    set(handles.setRandom,'Value',0);


% --- Executes on button press in setRandom.
function setRandom_Callback(hObject, eventdata, handles)
% hObject    handle to setRandom (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of setRandom
